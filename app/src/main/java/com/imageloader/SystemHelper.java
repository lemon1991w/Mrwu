...
public class SystemHelper {
	...
	/**
	 * 创建本应用的桌面快捷方式<br/>
	 * 注意：需要添加权�?lt;uses-permission android:name="com.android.launcher.permission.INSTALL_SHORTCUT"/&gt;  
	 * @param paramContext
	 */
	...
	/**
	 * �?��是否已经创建了桌面快捷方�?br/>
	 * 注意：需要添加权�?lt;uses-permission android:name="com.android.launcher.permission.READ_SETTINGS"/&gt;  
	 * @param ctx
	 * @return
	 */
	...
	/**
	 * 获取当前机器的屏幕信息对�?br/>
	 * 另外：�?过android.os.Build类可以获取当前系统的相关信息
	 * @param context
	 * @return
	 */
	...
	/**
	 * 获取手机�?br/>
	 * 注意：需要添加权�?lt;uses-permission
	 * android:name="android.permission.READ_PHONE_STATE"/&gt;。另外很多手机不能获取到当前手机�?
	 * 
	 * @param context
	 * @return
	 */
	...
	/**
	 * �?��当前网络连接的类�?br/>
	 * 注意：需要添加权�?<uses-permission  android:name="android.permission.ACCESS_NETWORK_STATE"/>;
	 * @param context
	...
	/**
	 * DisplayImageOptions是用于设置图片显示的�?圆角显示
